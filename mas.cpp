...
int main(int argc, char* argv[]) {
    ...
    Array array;
    Queue queue;
    DoublyLinkedList list; // Двусвязный список
    Spisok spisok; // Односвязный список
    Stack stack;
    NodeT* root = nullptr;
    ...
    try {
        ...
        list.loadFromFile("DoubleLinkedList.txt"); // Загрузка двусвязного списка
        spisok.loadFromFile(filename); // Загрузка односвязного списка
